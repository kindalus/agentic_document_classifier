...
class MetadadosComprovativoPagamento(MetadadosComunsBancario):
    ...
    entidade_pagamento: Optional[str] =  Field(default=None, description="Nome da entidade ou empresa que recebeu o pagamento.")
...
class BankingClassifierAgent(BaseAgent):
    ...
    def __init__(self, model = "gemini-2.5-flash-preview-05-20"):
        super().__init__(
            prompt_name="banking_classifier_prompt",
