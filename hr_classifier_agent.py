...
class HrClassifierAgent(BaseAgent):
    ...
    def __init__(self, prompt_path="hr_classifier_prompt.md", model="gemini-2.5-flash-preview-05-20"):
        super().__init__(prompt_path=prompt_path, response_type=AgentOutput, model=model)
