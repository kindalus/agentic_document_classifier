...
class ErrorOutput(BaseModel):
    ...
    numero_documento: Optional[str] = Field(default=None, description="Ecoado da entrada, se disponível.")
...
class BaseAgent:
    ...
    def __init__(self,response_type,  prompt_path,  model="gemini-2.5-flash-preview-05-20"):
        self.client = genai.Client()

        self.model = model
        self.prompt_ref = self.client.files.upload(file=prompt_path)
